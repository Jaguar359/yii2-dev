            ...
            <div class="col-lg-12">
                <div class="product-list">
                    <ul class="nav nav__product-list" id="lp-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="tab-two" data-toggle="tab" href="#tab2" role="tab"
                               aria-controls="tab2" aria-selected="false">WordPress</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="tab-four" data-toggle="tab" href="#tab4" role="tab"
                               aria-controls="tab4" aria-selected="false">PSD Template</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-five" data-toggle="tab" href="#tab5" role="tab"
                               aria-controls="tab5" aria-selected="false">Joomla</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-six" data-toggle="tab" href="#tab6" role="tab"
                               aria-controls="tab6" aria-selected="false">User Interface</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-single latest-single">
                                        ...
                                        <div class="product-excerpt">
                                            ...
                                            <ul class="titlebtm">
                                                <li>
                                                    <img class="auth-img" src="img/auth-img2.png"
                                                         alt="author image">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-single latest-single">
                                        ...
                                        <div class="product-excerpt">
                                            ...
                                            <ul class="titlebtm">
                                                <li>
                                                    <img class="auth-img" src="img/auth-img3.png"
                                                         alt="author image">
                ...
                <div class="row">
                    <div class="col-md-6 step-text r-padding">
                        <div>
                            ...
                            <p>Pellentesque facilisis the ullamcorper sapien interdum is the magna pellentesque
                                kequis.
                                Phasellus keur condimentum eleifend kerat Pellentesque facilisis the ullamcorper
                                sapien
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-md-12 slider-for">
                        <div class="tsingle">
                            ...
                            <p>Pellentesque facilisis the ullamcorper sapien interdum is the magna over was kelleu
                                pellen
                                tesque kequis. The mate was a mighty sailing Skipper this knew it was much more
                                walking.</p>
                            <h3>@Patrick Pool</h3>
                        ...
                        <div class="tsingle">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat exercitationem illo
                                dolor
                                animi a harum, mollitia quas suscipit sit voluptatibus facilis fugit, ullam
                                consequuntur
                                cumque.
                            </p>
                        ...
                        <div class="tsingle">
                            ...
                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis, cupiditate, cumque
                                iste
                                eos delectus, nisi culpa doloremque cum impedit velit quibusdam! Sapiente deserunt
                                debitis
                                totam.
                            </p>
                            <h3>@Mash Mortaza</h3>
